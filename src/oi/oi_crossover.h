/*
 * OverInteractive: personajes invitados de otras franquicias (Goku, Sonic, Madara) con sus ataques.
 *
 * Usan los huecos libres de NPC 293-299 (en el pack de assets solo tienen un "?" de relleno): gráficos propios en
 * graphics/npc/npc-29X.png (oi-crossover/mugen_chars.py), rasgos puestos al arrancar (OI_CrossoverSetup) y su IA
...
constexpr NPCID NPC_KAMEHAME  = NPCID(295);     // la bola grande
constexpr NPCID NPC_SONIC     = NPCID(296);
constexpr NPCID NPC_MADARA    = NPCID(297);     // Special4 = 1: clon
constexpr NPCID NPC_KUNAI     = NPCID(298);
constexpr NPCID NPC_KATON     = NPCID(299);     // bola de fuego de Madara
}
...
//! Nombre -> NPC para el puente ("goku", "sonic", "madara"); NPCID_NULL si no es uno de ellos.
